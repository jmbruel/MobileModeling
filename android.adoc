...
[WARNING]
====
Pour ne pas perdre du temps, commencez à lancer l'installation d'{as} si ce n'est déjà fait sur vos machines en téléchartgeant au choix depuis :
...
image::android/build.svg[alt="Build", width=80%]

=== Running

ifndef::slides[.Running of an Android app]
plantuml::android.plantuml[format=svg, alt="Running", width="50%"]
